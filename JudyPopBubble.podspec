...
Pod::Spec.new do |s|
  ...
  s.version          = '0.0.0'
  s.summary          = 'A short description of JudyPopBubble.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/醉翁之意/JudyPopBubble'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '醉翁之意' => 'Judy_u@163.com' }
  s.source           = { :git => 'https://github.com/醉翁之意/JudyPopBubble.git', :tag => s.version.to_s }
